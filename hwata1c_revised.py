...
Original file is located at
    https://colab.research.google.com/drive/1W-0ySUUIt_bIG1tf8LJNv4Bd8C0Vh-ZQ
"""
...
# Page setup
st.set_page_config(page_title="HWATA 1.01 – GeoAI Feature Extractor", layout="centered")
st.title("🏠 HWATA 1.01 – Building Footprint Extractor")
st.markdown("Upload a 20cm satellite or aerial image (GeoTIFF), and HWATA 1 will extract regularized building footprints as GeoJSON.")
...
if uploaded_img:
    ...
    st.download_button("📄 Download GeoJSON", geojson_str, file_name="building_footprints.geojson", mime="application/geo+json")
