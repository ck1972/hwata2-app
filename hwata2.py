...
# ====================== PAGE ======================
st.set_page_config(page_title="HWATA 2 – Improved Building Footprint Extractor", layout="centered")
st.title("🏠 HWATA 2 – Improved Building Footprint Extractor")
st.markdown(
...
def fetch_model_file() -> str:
    ...
    st.info("Downloading improved HWATA2 model from GitHub Releases…")
    headers = {}
...
if uploaded_img:
    ...
    try:
        ...
        st.success(f"✅ Model loaded (classes={num_classes})")
    except Exception as e:
    ...
    st.success("✅ Building footprints extracted and regularized with HWATA 2.")
